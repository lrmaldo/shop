    ...
    return {
      ...
      headerRight: () => (
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity underlayColor="white" onPress={() => navigation.navigate('Datos_tienda', {
  ...
  _regresar = () => {
    ...
    Alert.alert("Regresar", "Si tienes artículos en el carrito de esta tienda se van a eliminar ¿Estas seguro?",
      [
        ...
        {
          text: "OK", onPress: () => {
            AsyncStorage.removeItem('cart'); AsyncStorage.removeItem('datostienda');
      ...
      <ScrollView refreshControl={
        ...
        <View style={{ flex: 1, backgroundColor: "#f2f2f2" }}>
          <View style={{ width: width, alignItems: 'center' }} >
            ...
            <Swiper style={{ height: width / 2 }} key={this.state.dataBanner.length} showsButtons={false} autoplay={true} autoplayTimeout={2}>
              {
